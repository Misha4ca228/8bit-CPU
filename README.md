...
Процессора поддерживает 29 команд. Каждая инструкция представлена одним байтом (опкодом) и может иметь один или два операнда — регистры, адреса памяти или непосредственные значения.
...
| 27  | 0b00011011 | **PUSH** |       r       | Положить значение регистра `r` в стек             |
| 28  | 0b00011100 | **POP**  |       r       | Положить значение из стека в регистр `r`          |
